...
#
# Usage:
#   VPS_HOST=82.29.177.100 VPS_USER=root APP_PATH=/opt/city-airport-taxis-driver ./deploy/bootstrap-vps.sh
#
...
APP_PATH="${APP_PATH:?Set APP_PATH (e.g. /opt/city-airport-taxis-driver)}"
