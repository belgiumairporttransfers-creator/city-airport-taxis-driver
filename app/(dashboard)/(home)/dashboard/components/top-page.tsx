                ...
                >
                  {row.getVisibleCells().map((cell, index) => (
                    <TableCell
                      ...
                      className="text-sm text-default-700 border-b border-default-100 dark:border-border  last:text-end last:pr-6"
                    >
                      {flexRender(
          ...
          {table.getPageOptions().map((page, pageIndex) => (
            <li key={pageIndex}>
              <Button
                ...
                aria-current="page"
                className={cn(
                  "h-7 w-7 bg-default-100 text-default-600 p-0 hover:bg-default-200 dark:hover:text-primary-foreground hover:text-default",
                  {
