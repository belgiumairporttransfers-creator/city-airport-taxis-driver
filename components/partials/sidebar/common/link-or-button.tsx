  ...
  if (item.child) {
    return (
      <button
        ...
        className={cn(
          "flex items-center justify-between w-full relative before:absolute before:top-0 before:-left-[14px] before:w-[2px] before:h-0 before:transition-all before:duration-200 cursor-pointer text-default-700",
          {
