function Building({...props}: React.SVGProps<SVGSVGElement>) {
    return (
        ...
        {...props}
        >
<path opacity="0.35" d="M4.16992 2.5V14.47C4.16992 15.45 4.62992 16.38 5.41992 16.97L10.6299 20.87C11.7399 21.7 13.2699 21.7 14.3799 20.87L19.5899 16.97C20.3799 16.38 20.8399 15.45 20.8399 14.47V2.5H4.16992Z" fill="currentColor"/>
