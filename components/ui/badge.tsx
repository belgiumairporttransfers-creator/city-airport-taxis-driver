...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border border-border px-2.5 py-[2px] text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      color: {
      ...
      variant: {
        ...
        soft: "text-current bg-current/30  hover:text-primary-foreground",
      },
    },
    compoundVariants: [
      {
      ...
      },
      {
        ...
        color: "dark",
        className:
          "bg-current/10 text-accent-foreground hover:text-accent-foreground",
      },
    ],
    defaultVariants: {
      color: "default",
