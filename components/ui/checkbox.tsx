...
const checkboxVariants = cva(
  "peer group  shrink-0   ring-offset-background focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:stroke-primary-foreground cursor-pointer",
  {
    variants: {
      color: {
        default:
...
function Checkbox({
  ...
  icon = <Check />,
  ...props
}: React.ComponentProps<typeof CheckboxPrimitive.Root> & CheckboxProps) {
  return (
    <>
      {children ? (
